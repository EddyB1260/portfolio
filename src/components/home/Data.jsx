...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Edson Basilio
       <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
    ...
    <p className='home__description'>Sou um Programador amador localizado em Santa Catarina. 
    Muito dedicado e apaixonado pelo meu trabalho.</p>
